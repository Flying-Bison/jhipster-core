...
/**
 * Maps the list of allowable value entries to allowable values
...
function getacceptableValues(value) {
  return value.map(
    allowableValueEntry =>
      allowableValueEntry.constant
        ? getConstantValue(allowableValueEntry.allowableValue)
        : allowableValueEntry.allowableValue
  );
}
