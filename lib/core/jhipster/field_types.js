...
const CommonDBValidations = {
  String: new Set([
    ...
    Validations.PATTERN,
    Validations.ACCEPTABLE_VALUES
  ]),
  Integer: new Set([Validations.REQUIRED, Validations.MIN, Validations.MAX, Validations.ACCEPTABLE_VALUES]),
  ...
  Float: new Set([Validations.REQUIRED, Validations.MIN, Validations.MAX, Validations.ACCEPTABLE_VALUES]),
  Double: new Set([Validations.REQUIRED, Validations.MIN, Validations.MAX, Validations.ACCEPTABLE_VALUES]),
